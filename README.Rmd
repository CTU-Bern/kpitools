...
`r badger::badge_custom("dev version", as.character(packageVersion("kpitools")), "blue", "https://github.com/dcr-unibe-ch/kpitools")`
...
The package can also be installed from [github](https://github.com/dcr-unibe-ch/kpitools) via the `remotes` package
